    ...
    function rendernow() {
        ...
        function handleTheme(themeNumber) {
            ...
            if (themeNumber === "1") {               
                ...
                deleteColor.style.boxShadow="inset 0px -5px 0px 0px hsl(224, 28%, 35%)";
                resetColor.style.boxShadow="inset 0px -5px 0px 0px hsl(224, 28%, 35%)";
                ...
                deleteColor.style.boxShadow="inset 0px -5px 0px 0px hsl(185, 58%, 25%)";
                resetColor.style.boxShadow="inset 0px -5px 0px 0px hsl(185, 58%, 25%)";
                equalsColor.style.boxShadow="inset 0px -5px 0px 0px hsl(25, 99%, 27%)";
                ...
                deleteColor.style.boxShadow="inset 0px -5px 0px 0px hsl(285, 91%, 52%)";
                resetColor.style.boxShadow="inset 0px -5px 0px 0px hsl(285, 91%, 52%)";
                equalsColor.style.boxShadow="inset 0px -5px 0px 0px hsl(177, 92%, 70%)";
        ...
        function handleclick(key) {
            if (key === "DEL" || key === "RESET" || key === "=" || key === "Backspace" || key === "Enter" || key === "r") {
